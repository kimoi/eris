...
class Client extends EventEmitter {
    ...
    */
    editChannelPermission(channelID, overwriteID, allow, deny, type) {
        return this.callAPI("PUT", Endpoints.CHANNEL_PERMISSION(channelID, overwriteID), true, {
            ...
            deny,
            type
        }, true).then((permissionOverwrite) => new PermissionOverwrite(permissionOverwrite));
    }
    ...
    */
    callAPI(method, url, auth, body, file, forcePayload) {
        var resolve, reject;
        ...
        var actualCall = () => {
            ...
            if(file && file.file) {
                ...
                if((method === "GET" || method === "PUT") && !forcePayload) {
